...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	List<SignDTO> list = (ArrayList<SignDTO>)request.getAttribute("signStayList");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> 결재 진행함</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="">메인</a></li>
              <li><i class="icon_document_alt"></i>결재</li>
              <li><i class="fa fa-files-o"></i>결재 진행</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
