...
<body>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="PaymentForm">기안문작성</a></li>
              <li><a class="" href="">결재요청함</a></li>
              <li><a class="" href="">임시저장함</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
            ...
            <ul class="sub">
              <li><a class="" href="">결재대기함</a></li>
              <li><a class="" href="">결재진행함</a></li>
              <li><a class="" href="">완료문서함</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
  ...
  <!-- nice scroll -->
  <script src="resources/main/js/jquery.scrollTo.min.js"></script>
  <script src="resources/main/js/jquery.nicescroll.js" type="text/javascript"></script>
  <!-- jquery validate js -->
  <script type="text/javascript" src="resources/main/js/jquery.validate.min.js"></script>

  <!-- custom form validation script for this page-->
  <script src="resources/main/js/form-validation-script.js"></script>
